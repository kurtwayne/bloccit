...
RSpec.describe SponsoredPostsController do
  ...
  describe "GET new" do
    ...
    it "instantsiates @sponsored_post" do
      get :new, topic_id: my_topic.id
  ...
  describe "POST create" do
    ...
    it "assigns the new sponsored_post to @sponsored_post" do
      sponsored_post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence,
      body: RandomData.random_paragraph}
  ...
  describe "GET edit" do
   ...
   it "assigns sponsored_post to tbe updated to @sponsored_post" do
     get :edit, topic_id: my_topic.id, id: my_sponsored_post.id
